...
const Checkout = ({setOrder}) => {
  ...
  const handleOrder =()=> {
    const newOrder ={
      ...
      orderNumber: "12342",
      setShippingInfomation: shippingInfo,
          ...
          <div className='border p-2 mb-6'>
            ...
            <div className={`space-y-4 ${shippingToggle ? "" : "hidden"}`}>
              <div>
                ...
                <input type="address" name='address' placeholder='Enter your address' className='w-full px-3 py-2 border'  onChange={(e) => setShippingInfo({ ...shippingInfo, address: e.target.value })} />
              </div>
              <div>
                <label className='block text-gray-700'>City</label>
                <input type="city" name="city" placeholder='Enter your city' className='w-full px-3 py-2 border' 
                        onChange={(e) => setShippingInfo({ ...shippingInfo, city: e.target.value })}
                />
              </div>
              <div>
                <label className='block text-gray-700'>Postal Code</label>
                <input type="text" name="postal" placeholder='Enter your postal code' className='w-full px-3 py-2 border' 
