...
const Order = ({ order }) => {
  ...
  return (
    <div className='container px-4 py-8 mx-auto min-h-96 md:px-16 lg:px-24'>
      ...
      <p>Your order has been placed successfully. You will receive an email confirmation message soon.</p>
      <div className='mt-6 p-4 border rounded-lg bg-gray-100'>
        ...
        <div className='mt-6'>
          <button className='bg-green-500 text-white py-2 hover:bg-green-600'>Order Tracking</button>
